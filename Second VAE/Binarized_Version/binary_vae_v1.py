...
class Binary_Vae_v1(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 n_latent: int,
                 batch: int):
        super(Binary_Vae_v1, self).__init__()
        ...
        self.linear_mu = BinarizeLinear(256 * self.hidden_x * self.hidden_y, self.n_latent)
        self.linear_var = BinarizeLinear(256 * self.hidden_x * self.hidden_y, self.n_latent)

        self.dec_linear = BinarizeLinear(self.n_latent, 256 * self.hidden_x * self.hidden_y)
