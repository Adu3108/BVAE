...
class Binary_BetaVae_v1(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 input_d: Tuple[int],
                 batch: int = 1) -> None:
        super(Binary_BetaVae_v1, self).__init__()
        self.batch = batch
...
class Binary_Encoder_v1(torch.nn.Module):
    ...
    def __init__(self,
        ...
        super(Binary_Encoder_v1, self).__init__()
        self.n_latent = n_latent
        self.n_chan = n_chan
        self.input_d = input_d
        self.y_2, self.x_2 = self.get_layer_size(2)
