...
class Binary_BetaVae_v4(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 input_d: Tuple[int],
                 batch: int = 1) -> None:
        super(Binary_BetaVae_v4, self).__init__()
        self.batch = batch
        ...
        self.enc_conv1_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.enc_conv2_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.enc_conv3_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.enc_conv4_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.dec_conv4_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.dec_conv3_af = torch.nn.Hardtanh(inplace=True)
        ...
        self.dec_conv2_af = torch.nn.Hardtanh(inplace=True)
...
class Binary_Encoder_v4(torch.nn.Module):
    ...
    def __init__(self,
        ...
        super(Binary_Encoder_v4, self).__init__()
        self.n_latent = n_latent
        self.n_chan = n_chan
        self.input_d = input_d
        self.y_2, self.x_2 = self.get_layer_size(2)
